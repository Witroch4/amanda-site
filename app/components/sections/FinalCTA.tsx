...
const ctaContent = {
    oab: {
        title: "Não Deixe Seu Esforço Ser em Vão",
        subtitle: "A banca pode ter errado, e a lei está do seu lado.",
        cta: "Quero Falar com a Dra. Amanda",
    },
    prev: {
        title: "Seu Direito Não Pode Esperar",
        subtitle: "Análise gratuita do seu caso. Atendimento humanizado.",
